...
class MakeInit extends Command
{
    ...
    public function __construct()
    {
        ...
        $this->filelist = [
            ...
            'Logic'=>[
                'Shouba'=>[
                    'ShoubaOrder', 'ShoubaLog', 'ShoubaBill', 'ShoubaStock'
                ]
            ],
            'View'=>[
            ...
            'Model'=>[
                'Shouba'=>['shouba_bills_log', 'shouba_order', 'shouba_order_address', 'shouba_order_goods', 'shouba_order_refund', 'shouba_order_supplier_log', 'shouba_stock_log']
            ],
            'Event'=>[
            ...
            'job'=>[
                'ShoubaOrderComplete', 'ShoubaOrderSupplier', 'ShoubaOrderStatus'
            ]
        ];
        load_helper('Common');
    }
        ...
        foreach ($this->filelist as $appendSuffix =>$list){
            switch ($appendSuffix){
                ...
                case 'Logic':
                    ...
                    break;
                case "Model":
                    $this->createBase($appendSuffix,'Model');
